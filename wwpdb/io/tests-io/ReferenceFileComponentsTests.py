...
from wwpdb.io.locator.DataReference  import ReferenceFileComponents,ReferenceFileInfo
...
class ReferenceFileComponentsTests(unittest.TestCase):
    ...
    def testAccessors(self): 
        ...
        valid = { 'D_111111_sf_P1.cif.V3' : ['D_111111', 'structure-factors', 'pdbx', 1, 3],
        ...
        try:
            ...
            for fileName in self.__fileNameList:
                ...
                self.__lfh.write("RFC- fileName %s idcode %s contentType %s contentFormat %s partNo %d versionId %s\n" % 
